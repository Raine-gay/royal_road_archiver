...
/* ./.libs/lt-html2xhtml.c - temporary wrapper executable for .libs/html2xhtml.exe
...
const char * TARGET_PROGRAM_NAME = "html2xhtml.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.11\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# html2xhtml - temporary wrapper script for .libs/html2xhtml.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.11\n", f);
  fputs ("#\n", f);
  fputs ("# The html2xhtml program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"html2xhtml.exe:html2xhtml:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2 Debian-2.4.2-1.11\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"html2xhtml.exe:html2xhtml:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"html2xhtml.exe:html2xhtml:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
