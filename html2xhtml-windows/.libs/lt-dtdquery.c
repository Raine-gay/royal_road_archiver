...
/* ./.libs/lt-dtdquery.c - temporary wrapper executable for .libs/dtdquery.exe
...
const char * TARGET_PROGRAM_NAME = "dtdquery.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# dtdquery - temporary wrapper script for .libs/dtdquery.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.11\n", f);
  fputs ("#\n", f);
  fputs ("# The dtdquery program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"dtdquery.exe:dtdquery:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 ", f);
  fputs ("Debian-2.4.2-1.11\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dtdquery.exe:dtdquery:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dtdquery.exe:dtdquery:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
